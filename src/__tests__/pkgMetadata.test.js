...
/**
 * NodeJs sets process.cwd() to calling directory path. For now we are testing packageMetadata module by actual requiring
 * and asserting over root package.json. But in actual it will return calling module's package.json not alpha's package.json
 */
